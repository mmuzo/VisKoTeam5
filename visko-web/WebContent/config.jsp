<%--This JSP handles log in and will redirect to either Regular, or Privileged user home page --%>
...
{ 
	//Is priv.
	if(rs.getString(2).equals(pw) && userid.equals("testprivileged@test.com")) 
	{ 
